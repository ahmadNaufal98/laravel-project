            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-8 text-sm">
                        <div class="site-info">
                            <a href="#"><span class="mai-call text-primary"></span>+60142301895</a>
                            <span class="divider">|</span>
                            <a href="#"><span class="mai-mail text-primary"></span>na7147357@zohomail.com</a>
                        </div>
                    </div>
                    <div class="col-sm-4 text-right text-sm">
                        <div class="social-mini-button">
                            <a href="https://www.facebook.com/naufal.binahmad"><span
                                    class="mai-logo-facebook-f"></span></a>
                            <a href="https://www.linkedin.com/in/ahmad-naufal-7575a5258/"><span
                                    class="mai-logo-linkedin"></span></a>
                            <a href="https://www.instagram.com/hunter_naufal/?next=%2F"><span
    ...
    <div class="page-hero bg-image overlay-dark" style="background-image: url(../assets/img/bg_image_1.jpg);">
        <div class="hero-section">
            <div class="container text-center wow zoomIn">
                ...
                <a href="#appoitnment" class="btn btn-primary">Let's Consult</a>
            </div>
        </div>
    </div>
    ...
    <footer class="page-footer">
        <div class="container">
            <div class="row px-md-3">
                ...
                <h5 class="m-4 ">Social Media</h5>
                <div class="footer-sosmed mt-3">
                    <a href="https://www.facebook.com/naufal.binahmad" target="_blank"><span
                            class="mai-logo-facebook-f"></span></a>
                    <a href="https://www.instagram.com/hunter_naufal/?next=%2F" target="_blank"><span
                            class="mai-logo-instagram"></span></a>
                    <a href="https://www.linkedin.com/in/ahmad-naufal-7575a5258/" target="_blank"><span
                            class="mai-logo-linkedin"></span></a>
                </div>
            </div>
        </div>
